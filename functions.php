			...
			<form action="" method="post">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<p><a href="#" class="remember_me">Esqueceu a senha?</a> | <a href="#cadastro"
						                                                              data-toggle="modal"
						                                                              data-target="#registrationModal">Cadastre-se</a>
						</p>
					</div>
				</div>
			</form>
...
function pensandoodireito_bitly_url( $url, $format = 'xml', $version = '2.0.1' ) {
	if ( ! defined( "BITLY_LOGIN" ) || ! defined( "BITLY_APIKEY" ) ) {
		return $url;
	}
...
class Pensando_registration_form {
									...
									<div class="panel-body">
										<div id="form-cadastro">
											<form data-toggle="validator" role="form">
												...
												<div class="form-group">
													<label for="nomeUser">Nome de <span
															class="red">usuário</span>:</label>
													<input type="text" class="form-control" name="username"
													       id="username" placeholder="Nome de usuário"
													       data-error="Nome de usuário inválido ou já está em uso."
													       data-remote="wp-admin/admin-ajax.php?action=username_valid_ajax"
													       required>
													<span class="help-block">Usuário inválido ou já cadastrado</span>
												</div>
												<div class="form-group mt-md">
													<label for="nomeApres">Nome de <span
															class="red">apresentação:</span></label>
													<input type="text" class="form-control" id="nome" name="nome"
													       placeholder="Nome de apresentação" required>
												</div>
												<div class="form-group mt-md">
													<label for="email">E-mail</label>
													<input type="email" class="form-control" id="email" name="email"
													       placeholder="Seu e-mail"
													       data-error="Endereço de e-mail inválido ou já está em uso."
													       data-remote="wp-admin/admin-ajax.php?action=email_exists_ajax"
													       required>
												...
												<div class="form-group mt-md">
													...
													<input type="password" class="form-control" id="senha" name="senha"
													       data-minlength="8" maxlength="10" required>
													<span
														class="help-block">A senha deve conter de 8 à 10 caracteres.</span>
												</div>
												<div class="form-group mt-md">
													<input type="checkbox" name="termos_uso" name="termos_uso"
													       autocomplete="off"
													       data-error="Você deve ler e concordar com o termo antes de continuar o cadastro."
													       required> Li e aceito os <a
														href="<?php echo site_url( '/termos-de-uso/' ); ?>"
							...
							<div class="col-md-6">
								<div class="row">
									<div class="col-sm-4 col-xs-12">
										<img
											src="<?php echo get_template_directory_uri(); ?>/../pensandoodireito-tema/images/oquee/oquee-001.png"
											class="img-adptive"
											alt="Proteção de Dados Pessoais"/>
									</div>
									<div class="col-sm-8 col-xs-12">
										<h3 class="font-roboto red">Mais de
											<strong><?php echo get_user_count(); ?></strong> participantes!</h3>
										<ul class="list-unstyled text-left h5">
											...
											<li class="mt-sm text-success"><i class="fa fa-check"></i> fique por dentro
												das
												<strong>leis em elaboração</strong></li>
											<li class="mt-sm text-success"><i class="fa fa-check"></i>
										...
										<div class="panel-group" id="accordion" role="tablist"
											...
											<div class="panel panel-default">
												...
												<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel"
													...
													<div class="panel-body">
														<p>Porque esta é mais uma oportunidade de diálogo aberta pelo
															governo para ouvir
															a
															sociedade sobre temas importantes.</p>

														<p>Após realizar o seu cadastro, você poderá
															comentar os debates públicos abertos no site, concordar ou
															discordar de
															outros
															comentários, criar novas pautas e responder à pautas criadas
															por outros
															usuários.</p>

														<p>Por isso, ao se cadastrar, você será uma parte importante do
															processo,
															e sua opinião pode influenciar leis, decretos, portarias, e
															outras peças
											...
											<div class="panel panel-default">
												...
												<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
													...
													<div class="panel-body">
														Na plataforma, os "debates" podem ser projetos, anteprojetos de
														lei, textos de
														decreto ou portarias que estão abertos à participação social
														para sua
														consolidação. Eles se destinam a coletar opiniões diversas e
														qualificadas sobre
											...
											<div class="panel panel-default">
												...
												<div id="collapseThree" class="panel-collapse collapse" role="tabpanel"
													...
													<div class="panel-body">
														...
														Legislativos do Ministério da Justiça e do projeto Pensando o
														Direito.
													</div>
												</div>
											</div>
	...
	function registration() {
		...
		if ( is_wp_error( $validation ) ) {
			...
			$user_meta = array(
				'user_nice_name' => $userdata['user_nice_name'],
...
function get_page_by_name( $pagename ) {
	...
	foreach ( $pages as $page ) {
		if ( $page->post_name == $pagename_sanitized ) {
			return true;
		}
	}
